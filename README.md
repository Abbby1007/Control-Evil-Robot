...
About the Game:
Within the game you will play as an astronaut that will control a not so good robot. The goal is to get to the other robot.
The maze mechanic of the game is that the playetr will guide a robot through four mazes.
